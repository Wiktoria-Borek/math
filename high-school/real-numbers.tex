...
\section{Logarithms}
\subsection{Exercise}
Convert the following exponential equation $40^{x-1} = 2^{2x+1}$ into logarithmic form.
\subsubsection*{Solution}
$
  40^x \cdot \frac{1}{40} = 2^{2x} \cdot 2 \\
  40^x = 2^{2x} \cdot 80 \\
  40^x = 4^x \cdot 80 \\
  10^x = 80 \\
  \log_{10}{80} = x \\
...
\subsubsection*{Solution}
$
 \frac{\frac{3}{2} \log_a{b} \cdot \log_b{c}}{\frac{3}{4n} \log_a{c}} = \frac{\frac{3}{2} \cancel{\log_a{c}}}{\frac{3}{4n} \cancel{\log_a{c}}} = \frac{3}{2} \cdot \frac{4}{3} \cdot n = 2 \cdot n \quad \blacksquare
$
\end{document}
